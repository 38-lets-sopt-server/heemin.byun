...
public class PostController {
    ...
    public ResponseEntity<ApiResponse<PostResponse>> createPost(@RequestBody CreatePostRequest request) {
        ...
        return ResponseEntity
                ...
                .body(ApiResponse.success(PostSuccessCode.POST_CREATED, post));
    }
    ...
    public ResponseEntity<ApiResponse<List<PostResponse>>> getAllPosts() {
        ...
        return ResponseEntity.ok(ApiResponse.success(PostSuccessCode.POST_LIST_READ, posts));
    }
    ...
    public ResponseEntity<ApiResponse<PostResponse>> getPost(
        ...
        return ResponseEntity.ok(ApiResponse.success(PostSuccessCode.POST_READ, post));
    }
    ...
    public ResponseEntity<ApiResponse<PostResponse>> updatePost(
        ...
        return ResponseEntity.ok(ApiResponse.success(PostSuccessCode.POST_UPDATED, post));
    }

    // DELETE /posts/{id} 📝 과제
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> deletePost(@PathVariable final Long id) {
        // TODO: postService.deletePost() 호출, 예외 발생 시 에러 메시지 출력
        postService.deletePost(id);
        return ResponseEntity.ok(ApiResponse.success(PostSuccessCode.POST_DELETED));
    }
}